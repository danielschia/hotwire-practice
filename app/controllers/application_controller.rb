class ApplicationController < ActionController::Base
  ...
  def create_programming_language
    @programming_language = ProgrammingLanguage.new params
                                                    .require(:programming_language)
                                                    .permit(:name, :release_date, :language)
    @programming_language.save!

    @counter = ProgrammingLanguage.count

    @programming_language.broadcast_render_to :stream_test,partial: 
                                              'application/create_programming_language', 
                                              locals: { 
                                                counter: 
